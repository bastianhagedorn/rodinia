		...
		int total_iterations, int num_iterations, int blockCols, int blockRows, int borderCols, int borderRows) 
{
	...
	for (t = 0; t < total_iterations; t+=num_iterations) {
		...
		printf("grid_cols: %d\n", col);
		printf("grid_rows: %d\n", row);
		printf("border_cols: %d\n", borderCols);
		printf("border_rows: %d\n", borderRows);
		printf("Cap: %f\n", Cap);
		printf("Rx: %f\n", Rx);
		printf("Ry: %f\n", Ry);
		printf("Rz: %f\n", Rz);
...
void run(int argc, char** argv)
{
    ...
    printf("iterations: %d\npyramidHeight: %d\ngridSize: [%d, %d]\nborder:[%d, %d]\nblockGrid:[%d, %d]\ntargetBlock:[%d, %d]\n",\
	total_iterations, pyramid_height, grid_cols, grid_rows, borderCols, borderRows, blockCols, blockRows, smallBlockCol, smallBlockRow);
